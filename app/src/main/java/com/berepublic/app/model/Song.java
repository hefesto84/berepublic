...
public class Song {
    ...
    public int getTrackTimeMilis() {
        return trackTimeMilis;
    }

    public void setTrackTimeMilis(int trackTimeMilis) {
        this.trackTimeMilis = trackTimeMilis;
    }
    ...
    public boolean isStremeable() {
        return isStremeable;
    }

    public void setStremeable(boolean stremeable) {
        isStremeable = stremeable;
    }
}
